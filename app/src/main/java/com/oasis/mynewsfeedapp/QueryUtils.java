...
import static com.oasis.mynewsfeedapp.NewsActivity.LOG_TAG;
...
public class QueryUtils {
    ...
    /**
     * private because the query utils class is not supposed to be accessed by any outside class
     */
    private QueryUtils() {
    }
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                for (int j = 0; j < tags.length(); j++) {
                    ...
                    JSONObject tag_object = tags.getJSONObject(j);
                    author = author + tag_object.getString("webTitle");
                }

                String publishedOn = currentNews.getString("webPublicationDate");

                String detailsUrl = currentNews.getString("webUrl");


                News news = new News(title, author, publishedOn, detailsUrl);
    ...
    /**
     * Returns new URL oobject from the given string URL.
     */
    ...
    /**
     * Make an HTTP request to the given URL and return a string as the respnse.
     */
